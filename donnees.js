...
/* @DATA:MAJ */
var MAJ={tiers:["31/08/2026","brawltime.ninja (vote communautaire)"],
         cartes:["24/08/2026","topbrawl.com"],
         matchups:["31/08/2026","brawlcalculator.com"],
...
/* @DATA:TIERS */
var TIERS={
brawlBall:{S:"Surge,Bibi",A:"Nori,Griff,Damian,Mortis,Starr Nova,Bull,Edgar,Rico,Kenji,Chester,Mina,Stu",B:"Emz,Max,Meg,Bolt,Crow,Cordelius,Otis,Buzz,Shade,Fang,Sirius,Lumi,Spike,Colette,Melodie,Colt,Frank,Gale,Brock,Tara",C:"Kaze,Lou,Pierce,Clancy,Carl,Nita,Leon,Meeple,Darryl,Ash,Dynamike,Shelly,El Primo,Bo,8-Bit,Moe,Sandy,Kit,Alli,Buster,Draco,Jacky,Pearl,Ollie,Trunk,Ruffs,Maisie,Lily,Squeak,Doug,Finx,Poco",D:"Willow,Gigi,Hank,Najia,Gray,Charlie,Larry & Lawrie,Gus,Barley,Amber,Berry,Byron,Tick,Jessie,Bea,Jae-yong,Glowy,R-T,Penny,Mandy,Rosa,Ziggy,Sam,Mico,Sprout,Nani,Juju,Pam,Janet,Lola,Piper,Belle,Eve,Grom,Gene,Bonnie,Mr. P,Chuck,Angelo"},
bounty:{S:"Pierce,Brock",A:"Piper,Byron,Meeple,Nori,Najia,Belle,8-Bit",B:"Carl,Colt,Gus,Fang,Bea,Leon,Otis,Crow,Mandy,Nani,Bolt,Starr Nova,Charlie,Tick,Griff,Kit,Mina,Ruffs,Max,Edgar,Bo,Stu,Gene,Rico,Lily,Lumi,Surge,Angelo",C:"Meg,Gray,Spike,Mortis,Kaze,Janet,R-T,Colette,Squeak,Chester,Bonnie,Cordelius,Sprout,Jessie,Sirius,Damian,Tara,Glowy,Penny,Lou,Kenji,Moe,Maisie,Shade,Amber,Buzz,Alli,Finx,Grom,Emz,Jae-yong,Ziggy,Pearl,Bibi,El Primo,Melodie",D:"Bull,Gigi,Poco,Lola,Eve,Dynamike,Mr. P,Mico,Larry & Lawrie,Gale,Ollie,Shelly,Berry,Clancy,Juju,Barley,Buster,Willow,Darryl,Nita,Sandy,Chuck,Pam,Frank,Jacky,Draco,Doug,Ash,Trunk,Hank,Sam,Rosa"},
knockout:{S:"Spike,Pierce",A:"Byron,Brock,Nori,Piper,Mandy,Gray,Bea,Najia,Belle",B:"Meeple,Crow,Leon,Colt,Edgar,Starr Nova,8-Bit,Chester,Bolt,Tick,Rico,Gus,Max,Sirius,Nani,Surge,Finx,Mina,Angelo,Kit,Sprout,Meg,Fang,Otis,Griff,Colette,Squeak,Carl",C:"Amber,Gene,Lou,Kaze,Stu,Pearl,Kenji,Lily,Mico,Mortis,Janet,Emz,Alli,Lumi,Bo,Ruffs,Dynamike,Shade,Damian,Maisie,Charlie,R-T,Bonnie,Grom,Cordelius,Penny,Glowy,Buzz,Mr. P,Jessie,Ziggy,Lola,Poco,Willow",D:"Tara,Gale,Jae-yong,Juju,Larry & Lawrie,Bibi,Moe,Gigi,Berry,Eve,Melodie,Darryl,Barley,Buster,Bull,Doug,El Primo,Nita,Hank,Sandy,Ollie,Ash,Frank,Draco,Shelly,Chuck,Trunk,Clancy,Pam,Rosa,Jacky,Sam"},
gemGrab:{S:"Nori,Starr Nova,Griff",A:"Surge,Max,8-Bit,Meg,Bo,Crow,Chester,Bolt,Nani",B:"Emz,Otis,Tara,Damian,Kenji,Edgar,Mortis,Rico,Sirius,Mina,Bull,Stu,Bibi,Carl,Brock,Meeple,Cordelius,Ash,Spike",C:"Alli,Fang,Gus,Lumi,Sandy,Gene,Penny,Lou,Pierce,Pearl,Jessie,Leon,Shade,Squeak,Ruffs,Trunk,Gale,Kaze,Kit,Barley,Janet,Colette,Byron,Gigi,Lily,Amber,Najia,Gray,Finx,Darryl,Colt,Poco,Charlie,Buzz,Lola,Nita,R-T,Moe,Clancy,Berry",D:"Buster,Glowy,Dynamike,Frank,Belle,Ziggy,Draco,Juju,Ollie,Doug,Tick,Shelly,Sprout,Larry & Lawrie,Melodie,Bonnie,Piper,Jae-yong,El Primo,Bea,Rosa,Chuck,Grom,Mr. P,Willow,Pam,Jacky,Maisie,Mandy,Mico,Angelo,Hank,Eve,Sam"},
heist:{S:"8-Bit,Colt",A:"Nori,Brock,Chuck,Colette,Crow,Melodie,Mico,Jessie,Griff",B:"Edgar,Rico,Lumi,Amber,Penny,Nita,Bull,Meg,Pierce,Emz,Bo,Starr Nova,Kaze,Berry,Mandy,Carl,Sirius,Darryl,Spike,Surge",C:"Otis,Bibi,Dynamike,Cordelius,Nani,Moe,Bolt,Piper,Barley,Leon,Belle,Squeak,Lola,Chester,Lou,Shade,Tick,R-T,Najia,Pearl,Bonnie,Byron,Angelo,Larry & Lawrie,Juju,Charlie,Gigi,Clancy,Max,Buzz,Meeple,Eve,Ruffs,Damian,Jacky,Lily,Grom,Finx,Alli",D:"Bea,Mina,Trunk,Kenji,Ziggy,Ash,Fang,Gale,Draco,El Primo,Kit,Gus,Willow,Sprout,Shelly,Doug,Frank,Tara,Hank,Mr. P,Maisie,Pam,Sandy,Glowy,Mortis,Janet,Stu,Sam,Rosa,Gene,Poco,Buster,Jae-yong,Gray,Ollie"},
hotZone:{S:"8-Bit,Emz,Bo,Pierce",A:"Surge,Nori,Damian,Griff,Lumi,Mina,Starr Nova,Sirius,Crow,Lou,Meg,Amber,Bibi,Gale",B:"Tick,Edgar,Tara,Penny,Fang,Brock,Barley,Kenji,Squeak,Berry,Otis,Jessie,Sandy,Buster,Spike,Chester,Shade,Poco,Finx,Chuck,Clancy,Jae-yong",C:"Byron,Carl,Gray,Frank,Bull,Draco,Willow,Max,Ruffs,Colette,Sprout,Doug,Grom,Juju,Ash,Kaze,Pearl,Bolt,Hank,Najia,Dynamike,Melodie,Leon,Gigi,Nita,Larry & Lawrie,Maisie,Glowy,Meeple,Ziggy,R-T,Moe,Pam,Alli,Mr. P,Stu,Trunk,Rosa,Buzz,Rico,Mortis,Jacky,Janet",D:"Bea,Cordelius,Gus,Lola,Ollie,Colt,Darryl,Eve,Mico,Charlie,Nani,El Primo,Lily,Gene,Belle,Mandy,Sam,Kit,Bonnie,Piper,Angelo,Shelly"}};
/* @END:TIERS */
