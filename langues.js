...
var LANGUES = {
  ...
  fr: {
    ...
    txt: {
      ...
      retirerBan: "Retirer {nom} des bannis",
      retirer: "Retirer {nom}",
      ...
      analyseIntro: "{n} brawlers de ton roster, classés. La barre montre d'où viennent les points : son niveau, la carte, ce qu'il bat en face, ton équipe — et ce que le risque retranche.",
  ...
  en: {
    ...
    txt: {
      ...
      analyseIntro: "{n} brawlers from your roster, ranked. The bar shows where the points come from: its tier, the map, what it beats, your team — and what risk takes back.",
  ...
  es: {
    ...
    txt: {
      ...
      retirerBan: "Quitar a {nom} de los baneados",
      ...
      analyseIntro: "{n} brawlers de tu lista, clasificados. La barra muestra de dónde vienen los puntos: su nivel, el mapa, a quién gana enfrente, tu equipo — y lo que el riesgo resta.",
